...
async function exibirProdutos() {
    ...
    try {
        const response = await fetch("https://feijoada-da-dayse.onrender.com/produtos");
        ...
        lista.forEach((produto, index) => {
            ...
            col.innerHTML = `
                <div class="card product-card shadow-sm border-0 rounded-4 h-100">
                    <img src="${produto.imagem}" class="card-img-top rounded-top-4" alt="${produto.nome}" style="height: 200px; object-fit: cover;" />
